  ...
  <div className="container">
    <div className="row">
      <div className="col-lg-10 offset-lg-1">
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="text-container last">
              ...
              <p> By visiting Evolo or using the Services you agree to the use of cookies in your browser and HTML-based emails. Cookies are small text files placed on your device when you visit a Cookies are small text files placed on your device when you visit a Cookies are small text files placed on your device when <a className="turquoise" href="#your-link">web site</a> in order to track.</p>
            </div> {/* end of text container */}
          </div> {/* end of col*/}
          <div className="col-md-6">
            {/* Privacy Form */}
            <div className="form-container">
              <form id="privacyForm" data-toggle="validator" data-focus="false" noValidate="true">
                <div className="form-group has-error has-danger">
                  ...
                  <div className="help-block with-errors"><ul className="list-unstyled"><li>Please fill in this field.</li></ul></div>
                </div>
                <div className="form-group has-error has-danger">
                ...
                <div className="form-group has-error has-danger">
                  <select className="form-control-select" id="pselect" required>
                    <option className="select-option" value disabled selected>Select Option</option>
                  ...
                  <div className="help-block with-errors"><ul className="list-unstyled"><li>Please select an item in the list.</li></ul></div>
                </div>
                <div className="form-group checkbox">
                  <input type="checkbox" id="pterms" defaultValue="Agreed-to-Terms" required />I have read and agree to Evolo's <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a>
                  <div className="help-block with-errors" />
                </div>
                <div className="form-group">
                  <button type="submit" className="form-control-submit-button disabled">SUBMIT</button>
                </div>
        ...
        <a className="btn-outline-reg back" href="/">BACK</a>
      </div> {/* end of col*/}
    </div> {/* end of row */}
  </div> {/* end of container */}
</div>
